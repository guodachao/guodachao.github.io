...
![](..//assets/images/2017/jvm/jconsole01.jpg)
...
![](..//assets/images/2017/jvm/jvisualvm.jpg)
...
![](..//assets/images/2017/jvm/jvisualvm01.jpg)


VisualVM可以根据需要安装不同的插件，每个插件的关注点都不同，有的主要监控GC，有的主要监控内存，有的监控线程等。

 
![](..//assets/images/2017/jvm/jvisualvm02.jpg)
...
![](..//assets/images/2017/jvm/jvisualvm03.jpg)
...
![](..//assets/images/2017/jvm/mat01.jpg)
...
![](..//assets/images/2017/jvm/mat02.jpg)

- Dominator Tree：列出最大的对象以及其依赖存活的Object （大小是以Retained Heap为标准排序的）

 
![](..//assets/images/2017/jvm/mat03.jpg)

- Top Consumers ： 通过图形列出最大的object

 
![](..//assets/images/2017/jvm/mat04.jpg)
...
![](..//assets/images/2017/jvm/mat05.jpg)


- Top Components: 列出大于总堆数的百分之1的报表。

 
![](..//assets/images/2017/jvm/mat06.jpg)
...
- [jvm系列(四):jvm调优-命令篇]({{ site.url }}/java/2016/01/01/jvm%E8%B0%83%E4%BC%98-%E5%91%BD%E4%BB%A4%E7%AF%87.html)
...
**作者：纯洁的微笑**  
**出处：[{{ site.url }}/]({{ site.url }}/java/2017/02/22/jvm-tool.html)**      
**版权归作者所有，转载请注明出处** 

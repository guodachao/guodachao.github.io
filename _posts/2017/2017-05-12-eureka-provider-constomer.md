...
![](..//assets/images/2017/springcloud/eureka_server.png)
...
![](..//assets/images/2017/springcloud/eureka_server2.png)
...
**作者：纯洁的微笑**  
**出处：[{{ site.url }}/]({{ site.url }}/springcloud/2017/05/12/eureka-provider-constomer.html)**      
**版权归作者所有，转载请注明出处** 

...
![](/assets/images/2017/springcloud/hystrix-dashboard-1.jpg)
...
![](/assets/images/2017/springcloud/hystrix-dashboard-2.jpg)

其实就是http://localhost:9001/hystrix.stream返回结果的图形化显示，Hystrix Dashboard Wiki上详细说明了图上每个指标的含义，如下图：

 
![](/assets/images/2017/springcloud/hystrix-dashboard-3.png)
...
![](/assets/images/2017/springcloud/turbine-01.jpg)
...
-------------
**作者：纯洁的微笑**  
**出处：[{{ site.url }}/]({{ site.url }}/springcloud/2017/05/18/hystrix-dashboard-turbine.html)**      
**版权归作者所有，转载请注明出处** 
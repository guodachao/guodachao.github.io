...
![](..//assets/images/2017/cloudfavorites/gradle1.png)


2、导入项目

 
![](..//assets/images/2017/cloudfavorites/gradle2.png)


 
![](..//assets/images/2017/cloudfavorites/gradle3.png)


3、选择gradle的方式导入

 
![](..//assets/images/2017/cloudfavorites/gradle4.png)


 
![](..//assets/images/2017/cloudfavorites/gradle5.png)
...
![](..//assets/images/2017/cloudfavorites/gradle6.png)


发现有部分的jar包级别是Provided  

 
![](..//assets/images/2017/cloudfavorites/gradle7.png)


5、将标红色部分的jar级别由Provided改为Compile(最新版本已经修复，使用最新版本构建可以跳过第4、5步)

 
![](..//assets/images/2017/cloudfavorites/gradle8.png)
...
![](..//assets/images/2017/cloudfavorites/mvn3.png)

...
前两篇文章我们介绍了 Dockerfile 的使用[Docker(二)：Dockerfile 使用介绍]({{ site.url }}/docker/2018/03/12/docker-use-dockerfile.html)，我们知道使用一个 Dockerfile 模板文件可以定义一个单独的应用容器，如果需要定义多个容器就需要服务编排。服务编排有很多种技术方案，今天给大家介绍 Docker 官方产品 Docker Compose 。
...
![](..//assets/images/2018/docker/docker-compose.png)
...
![](..//assets/images/2018/docker/quick-hello-world-1.png)
...
![](..//assets/images/2018/docker/quick-hello-world-2.png)
